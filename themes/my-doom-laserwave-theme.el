;;; my-doom-laserwave-theme.el --- custom laserwave variant -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Based on doom-laserwave by hyakt
;;
;;; Commentary:
;;; Code:
...
(defgroup my-doom-laserwave-theme nil
  "Options for the `my-doom-laserwave' theme."
  :group 'doom-themes)
...
(def-doom-theme my-doom-laserwave
  ...
  ((bg         '("#27212E" nil       nil            ))
   ...
   (variables      fg)
   (numbers        orange)
   (region         `(,(doom-blend (car bg) (car magenta) 0.8)
   ...
   (-modeline-pad
    (when my-doom-laserwave-padded-modeline
      (if (integerp my-doom-laserwave-padded-modeline)
          my-doom-laserwave-padded-modeline 4)))
  ...
  ((lazy-highlight :background (doom-darken magenta 0.4) :foreground fg)
   ...
   ;; (org-done :foreground base7 :bold 'inherit)
   ;;;; org-pomodoro
