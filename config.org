...
#+begin_src emacs-lisp
  (use-package ruby-mode
    ...
    ;; Format with prettier or rubocop
    (after! (apheleia)
            ;; Use prettier if available, otherwise rubocop
            (setf (alist-get 'ruby-mode apheleia-mode-alist) 'prettier-ruby)
            (setf (alist-get 'prettier-ruby apheleia-formatters)
                  '(npx "prettier" "--parser=ruby" filepath)))

    ;; Keybindings
    (map-leader! :n ruby-mode-map "SPC"
                 "'" (cmd! (inf-ruby)))
  ...
  (use-package rspec-mode
    ...
    (map-leader! :n (rspec-verifiable-mode-map rspec-mode-map) "SPC"
                 :prefix ("t" . "test")
                 "a" #'rspec-verify-all
                 "r" #'rspec-rerun
                 "v" #'rspec-verify
  ...
  (use-package minitest
    :after ruby-mode
    :config
    (map-leader! :n minitest-mode-map "SPC"
                 :prefix ("t" . "test")
                 "r" #'minitest-rerun
  ...
  (use-package projectile-rails
    :hook ((ruby-mode inf-ruby-mode) . projectile-rails-mode)
    :config
    (setq projectile-rails-expand-snippet nil
          inf-ruby-console-environment "development")

    (map-leader! :n projectile-rails-mode-map "SPC"
                 :prefix ("r" . "rails")
                 "r" #'projectile-rails-console
                 "R" #'projectile-rails-server
                 ...
                 "J" #'projectile-rails-find-current-javascript
                 "l" #'projectile-rails-find-lib
                 "g" #'projectile-rails-find-migration
                 "G" #'projectile-rails-find-current-migration
                 "x" #'projectile-rails-extract-region))
...
** =magit=
#+begin_src emacs-lisp
  (use-package transient ) ;; Dep of Magit
  (use-package magit
    :after transient
    :config
    (general-def
